# Minimalist Pekko Observability
...
![Maven Central](https://img.shields.io/maven-central/v/nl.pragmasoft.pekko/sensors˚-core_2.13?color=%2300AA00)
...
libraryDependencies ++= 
  Seq(
     "nl.pragmasoft.pekko" %% "sensors" % "0.7.1",
  )
```
