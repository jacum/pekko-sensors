...
object Dependencies {
  ...
  object Prometheus {
    val hotspot        = "io.prometheus" % "prometheus-metrics-instrumentation-jvm"    % "1.4.2"
    val common         = "io.prometheus" % "prometheus-metrics-core"                   % "1.4.2"
    val exposition     = "io.prometheus" % "prometheus-metrics-exposition-textformats" % "1.4.2"
    val exporterCommon = "io.prometheus" % "prometheus-metrics-exporter-common"        % "1.4.2"
