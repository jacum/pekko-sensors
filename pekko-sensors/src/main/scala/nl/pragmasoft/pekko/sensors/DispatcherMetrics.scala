  ...
  def make(): DispatcherMetrics =
    DispatcherMetrics(
      ...
      activeThreads = Histogram
        .builder()
        .classicOnly()
        .name("pekko_sensors_dispatchers_active_threads")
        .help(s"Active worker threads")
        .labelNames("dispatcher")
        .build(),
      threadStates = Gauge
        .builder()
        .name("pekko_sensors_dispatchers_thread_states")
        .help("Threads per state and dispatcher")
        .labelNames("dispatcher", "state")
        .build(),
      threads = Gauge
        .builder()
        .name("pekko_sensors_dispatchers_threads")
        .help("Threads per dispatcher")
        .labelNames("dispatcher")
        .build(),
      executorValue = Gauge
        .builder()
        .name("pekko_sensors_dispatchers_executor_value")
