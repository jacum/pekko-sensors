  ...
  def make(): SensorMetrics =
    SensorMetrics(
      activityTime = Histogram
        ...
        .name("pekko_sensors_actor_activity_time_seconds")
        .help(s"Seconds of activity")
        .labelNames("actor")
        .build(),
      activeActors = Gauge
        .builder()
        .name("pekko_sensors_actor_active_actors")
        .help(s"Active actors")
        .labelNames("actor")
        .build(),
      unhandledMessages = Counter
        .builder()
        .name("pekko_sensors_actor_unhandled_messages")
        .help(s"Unhandled messages")
        .labelNames("actor", "message")
        .build(),
      exceptions = Counter
        .builder()
        .name("pekko_sensors_actor_exceptions")
      ...
      receiveTime = Histogram
        ...
        .name("pekko_sensors_actor_receive_time_millis")
        .help(s"Millis to process receive")
        .labelNames("actor", "message")
        .build(),
      receiveTimeouts = Counter
        .builder()
        .name("pekko_sensors_actor_receive_timeouts")
        .help("Number of receive timeouts")
        .labelNames("actor")
        .build(),
      clusterEvents = Counter
        .builder()
        .name("pekko_sensors_actor_cluster_events")
        .help(s"Number of cluster events, per type")
        .labelNames("event", "member")
        .build(),
      clusterMembers = Gauge
        .builder()
        .name("pekko_sensors_actor_cluster_members")
        .help(s"Cluster members")
        .build(),
      recoveryTime = Histogram
        .builder()
        .classicExponentialUpperBounds(0.5, 2, 14)
        .name("pekko_sensors_actor_recovery_time_millis")
      ...
      recoveryToFirstEventTime = Histogram
        .builder()
        .classicExponentialUpperBounds(0.5, 2, 14)
        .name("pekko_sensors_actor_recovery_to_first_event_time_millis")
      ...
      persistTime = Histogram
        .builder()
        .classicExponentialUpperBounds(0.5, 2, 14)
        .name("pekko_sensors_actor_persist_time_millis")
        .help(s"Millis to process single event persist")
        .labelNames("actor", "event")
        .build(),
      recoveries = Counter
        .builder()
        .name("pekko_sensors_actor_recoveries")
        .help(s"Recoveries by actors")
        .labelNames("actor")
        .build(),
      recoveryEvents = Counter
        .builder()
        .name("pekko_sensors_actor_recovery_events")
        .help(s"Recovery events by actors")
        .labelNames("actor")
        .build(),
      persistFailures = Counter
        .builder()
        .name("pekko_sensors_actor_persist_failures")
        .help(s"Persist failures")
        .labelNames("actor")
        .build(),
      recoveryFailures = Counter
        .builder()
        .name("pekko_sensors_actor_recovery_failures")
        .help(s"Recovery failures")
        .labelNames("actor")
        .build(),
      persistRejects = Counter
        .builder()
        .name("pekko_sensors_actor_persist_rejects")
        .help(s"Persist rejects")
        .labelNames("actor")
        .build(),
      waitingForRecovery = Gauge
        .builder()
        .name("pekko_sensors_actor_waiting_for_recovery_permit_actors")
      ...
      waitingForRecoveryTime = Histogram
        .builder()
        .classicExponentialUpperBounds(0.5, 2, 14)
        .name("pekko_sensors_actor_waiting_for_recovery_permit_time_millis")
