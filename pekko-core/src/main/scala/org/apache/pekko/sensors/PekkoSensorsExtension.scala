...
import org.apache.pekko.sensors.actor.ClusterEventWatchActor
 ...
 */
class PekkoSensorsExtension(system: ExtendedActorSystem) extends Extension with MetricsBuilders with LazyLogging {

  logger.info(s"Pekko Sensors extension has been activated: ${this.getClass.getName}")

  val namespace = "pekko_sensors"
  val subsystem = "actor"
